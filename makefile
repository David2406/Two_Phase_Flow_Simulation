...
#LIB_DIR=/home/iampietro/Documents/These_EDF/Year_2015_2016/Projet_short_studies/Libraries/
...
#$(info $$OBJS is [${OBJS}]) , pour imprimer ce que contient la variable OBJS

$(info Chemin vers la biliotheque est [${LIB_DIR}${LDLIBS}])
...
#make dist-clean pour supprimer tous l'éxécutable Low_Mach

dist-clean: 
	$(RM) $(SCHEME_TYPE)_$(CASE)
